 ...
 useEffect(()=>{
        ...
        console.log("forbiddden");
         navigate("/");
                ...
                try{
         const response = await axios.get("https://joulz-vite-app-backend.onrender.com/api/products" , {
                headers:{
...
fetchData();
             ...
             const deleteProductById = async (userId) => {
                     await axios.delete(`https://joulz-vite-app-backend.onrender.com/api/delete/product/${userId}`)
                    .then((response) => {
